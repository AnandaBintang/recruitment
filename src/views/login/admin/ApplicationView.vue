                                ...
                                <div class="row">
                                    <div class="col-lg-10 offset-lg-1">
                                        <div class="table-responsive table-billing-history mt-3">
                                            ...
                                            <div class="mt-3 mb-3">
                                                <button class="btn btn-danger btn-sm" type="submit" @click.prevent="reject()" v-if="level != 'direktur'"><i class="fa fa-xmark"></i></button> |
                                                <button class="btn btn-warning btn-sm" type="submit" @click.prevent="openInfo()"><i class="fa fa-info"></i></button> |
                                                <button class="btn btn-success btn-sm" type="submit" @click.prevent="accept()" v-if="level != 'direktur'"><i class="fa fa-check"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
